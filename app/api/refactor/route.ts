...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system: `You are an expert code refactoring assistant. Focus ONLY on essential refactoring that eliminates actual code smells. Do not over-engineer or make unnecessary changes.
